...
agency_with_better_cli: agency.bin $(D2J) $(SRC)/agency.drawio
	@echo 'running...'
	$(D2J) $(SRC)/agency.drawio
	./agency.bin $(SRC)/agency.drawio
...
agency.bin: agency/*.odin $(0D) ../llm/agency/main
	@echo 'building...'
	odin build agency $(ODIN_FLAGS)
